...
//CODE CONFIRMATION
exports.authRouter.post('/registration-confirmation', attempts_middleware_1.requestAttemptsMiddleware, input_valudation_middleware_1.codeConfirmationCheck, input_valudation_middleware_1.inputValidationMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.authRouter.post('/registration-email-resending', attempts_middleware_1.requestAttemptsMiddleware, input_valudation_middleware_1.emailConfirmationCheck, input_valudation_middleware_1.inputValidationMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
//REFRESH TOKEN
exports.authRouter.post('/refresh-token', attempts_middleware_1.requestAttemptsMiddleware, auth_middlewares_1.checkForRefreshToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const title = req.headers["user-agent"] || "unknown";
